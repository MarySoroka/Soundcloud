...
<div class="row grey darken-2 white-text">
    <div class="section">
        <div class="col s12 offset-l1">
            <div class="row">
                <h1 class="title"><fmt:message key="help.page"/></h1>
            </div>
            <div class="row">
                <div class="col s7">
                    <span><fmt:message key="help.text"/></span>
                </div>
            </div>
        </div>
    </div>
...
<footer:footer  policy="${ApplicationConstants.COMMAND_NAME_PARAM}=${CommandType.GET_PAGE_COMMAND}&${ApplicationConstants.REQUEST_PARAMETER_PAGE}=${ApplicationPage.POLICY}"
        ...
        page="${ApplicationConstants.COMMAND_NAME_PARAM}=${CommandType.GET_PAGE_COMMAND}&${ApplicationConstants.REQUEST_PARAMETER_PAGE}=${ApplicationPage.HELP}"/>
